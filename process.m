...
% =========================================================================
% ΔΙΑΓΡΑΜΜΑ 4: ΣΥΣΧΕΤΙΣΗ ΦΟΡΤΟΥ ΚΑΙ CPU (Scatter Plot)
% =========================================================================
figure('Name', 'CPU vs Load Correlation', 'NumberTitle', 'off');

% Χρησιμοποιούμε τη συνάρτηση scatter για διάγραμμα διασποράς
scatter(total_rate_hz, cpu_pct, 15, 'filled', 'MarkerFaceAlpha', 0.4, 'MarkerFaceColor', [0 0.5 0.5]);

title('Συσχέτιση Ρυθμού Εισερχόμενων Μηνυμάτων και Χρήσης CPU');
xlabel('Ρυθμός Εισερχόμενης Κίνησης (Μηνύματα / sec)');
ylabel('Συνολική Χρήση CPU (%)');
grid on;

% Προαιρετικά: Όρια αξόνων για πιο καθαρή εικόνα
xlim([0 max(total_rate_hz) + 10]);
ylim([0 100]);
...
% =========================================================================
fprintf('\n======================================================\n');
fprintf('  ΤΕΛΙΚΑ ΣΤΑΤΙΣΤΙΚΑ (24ΩΡΟ)\n');
fprintf('======================================================\n');
